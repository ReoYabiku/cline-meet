...
type RoomRepository interface {
	...
	GetByHostID(ctx context.Context, hostID uuid.UUID) ([]*domain.Room, error)
	...
	GetActiveRooms(ctx context.Context) ([]*domain.Room, error)
...
type MessageRepository interface {
	...
	SaveChatMessage(ctx context.Context, message *domain.Message) error
	...
	GetChatHistory(ctx context.Context, roomID uuid.UUID, limit int) ([]*domain.Message, error)
